...
[![Version](https://img.shields.io/badge/version-v599-blue.svg)](https://moteur.studio)
...
### v537 (juin 2026)
- ✨ Visite guidée interactive (onboarding multi-chapitres)
- ✨ Module Contrats complet (éditeur en blocs, feuille de service, export PDF)
- ✨ Sécurité : buckets de stockage privés, RLS renforcée, sanitization XSS
- 🐛 Corrections export PDF (storyboard, feuilles de service, résumés)
- 🐛 Fix gel d'authentification au réveil d'onglet

[Voir l'historique complet →](https://github.com/gadmy/moteur/commits/main)
